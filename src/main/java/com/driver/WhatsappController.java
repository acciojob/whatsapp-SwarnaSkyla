...
public class WhatsappController {
    ...
    @PostMapping("/add-user/{name}/{mobile}")
    public String createUser(@PathVariable("name") String name, @PathVariable("mobile") String mobile) throws Exception {
    ...
    public int createMessage(@PathVariable("message") String content){
    ...
    public String findMessage(@RequestBody Date start, @RequestBody Date end, @RequestBody int K) throws Exception{
        //This is a bonus problem and does not contains any marks
